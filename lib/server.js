var LanguageServer, path, fuzzysort, SourceMapConsumer, CompletionItemKind, SymbolKind, connection, documents, activeContext, livescript, lexer, Compiler, ref$, type, parent, transformEsm, livescriptTransformImplicitAsync, CompletionContext, BuildInClassProvider, BuildInConstructorProvider, KeywordProvider, OperatorProvider, ImportProvider, compiler, lastValid, symbols, Code, inCodeName, startsWithUpperCase, toDashCase, analyzeAst, safeCall, safeDelay, compileCode, verify, settings, workspaceRoot, providers, i$, provider, nodeDebugInfo, nodeDebugParents, nodeLocation, symbolProvider, e, message, toString$ = {}.toString;
...
try {
  ...
  BuildInConstructorProvider = require('./providers/BuildInConstructorProvider');
  KeywordProvider = require('./providers/KeywordProvider');
  ...
  connection.onCompletion(function(context){
    var result, completionContext, s, id, variableNames, sorted, variableHints, i$, ref$, provider, e, this$ = this;
    result = [];
    try {
